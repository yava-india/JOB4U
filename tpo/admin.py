...
from tpo.models import zycus

admin.site.register(virtusa)
# admin.site.register(zycus)
# admin.site.register(IBM)
# admin.site.register(infosys15oct)
# admin.site.register(infosys16oct)
# admin.site.register(IBM7oct)
# #admin.site.register(Headstrait)
# admin.site.register(A_1_Salasar)
# admin.site.register(Lti_23_oct)
